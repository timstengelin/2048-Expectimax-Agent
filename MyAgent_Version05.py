# 5. Version: ExpectiMax with Further-Extended Heuristic and Best Move Memory
...
class Player(BasePlayer):
    ...
    def moveOrder(self, state):
        ...
        if self._bestMove is not None and self._bestMove in actions:
            # place the previously best move first for better move ordering
            actions = [self._bestMove] + [a for a in actions if a != self._bestMove]
        return actions
